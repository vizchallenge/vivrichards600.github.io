...
modified: 2017-09-16
category: Events
tags: [DDD, speaking, conference, attending]
imagefeature: 
mathjax: 
chart: 
comments: true
...
![_config.yml]({{ site.baseurl }}/images/dddflag.png)
...
My talk was at 2PM but at 1:30PM I headed up to the room to ensure I could plug my laptop in as well as check that my slides displayed well on the screen and could be read from the back. Unfortunately again the project wasn't the best and so the text was a little blurry at the back of the room.
...
![_config.yml]({{ site.baseurl }}/images/dddea-whereswally.png)
...
![_config.yml]({{ site.baseurl }}/images/dddea-presenting.png)
